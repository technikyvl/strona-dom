...
export function Dock({
  ...
  return (
    <motion.div style={{ height, scrollbarWidth: "none" as unknown as number }} className="mx-2 flex max-w-full items-end overflow-x-auto">
      <motion.div
        onMouseMove={({ pageX }) => {
          isHovered.set(1)
          mouseX.set(pageX)
        ...
        className={cn("mx-auto flex w-fit gap-4 rounded-2xl px-4", bgClass, backdropClass, className)}
