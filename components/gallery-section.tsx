...
export function GallerySection() {
  ...
  return (
    <section id="galeria" ref={ref as any} className="py-24 bg-gradient-to-b from-[#1a1e2e] to-[#0a0e1a]">
      <div className="container mx-auto px-6">
        ...
        <div className={`grid grid-cols-2 md:grid-cols-3 gap-4 transition-all duration-1000 ease-out ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          {images.map((src, idx) => (
